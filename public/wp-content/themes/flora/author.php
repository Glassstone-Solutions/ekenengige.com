...
<div id="content">
    ...
    global $wyde_options, $wyde_sidebar_position, $wyde_blog_layout;
    
    $wyde_sidebar_position = $wyde_options['blog_archive_sidebar'];

    $wyde_blog_layout = $wyde_options['blog_archive_layout'];

    $grid_columns = $wyde_options['blog_archive_grid_columns'];

    $pagination = $wyde_options['blog_archive_pagination'];
    ...
    if( empty($description) ) {
		$description .= '<p>'.sprintf( __( '%s has created %s entries.', 'flora' ), $name, count_user_posts( $author_id ) ).'</p>';
	}
