...
<div<?php echo wyde_get_attributes( $attrs );?>>
    ...
    <?php echo do_shortcode(sprintf('[wyde_link_button title="%s" link="%s" icon="%s" color="%s" hover_color="%s" size="%s" style="%s"]', 
        $button_text, $link, $icon, $color, $hover_color, $size, $style)); ?>
    </div>
    <?php endif;?>
</div>
