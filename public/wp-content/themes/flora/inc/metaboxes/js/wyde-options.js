(function ($) {
    ...
    $(document).ready(function () {
        ...
        function toggleLayout() {
            $("#cmb2-metabox-page_options .cmb-row:not(.cmb2-id--w-layout)").toggle($("#_w_layout").val() == 'boxed');
            if ($("#_w_layout").val() == 'boxed') {
                toggleSidebar();
            }
            tabsChanged();
        }
        toggleLayout();
        $("#_w_layout").change(function () {
            toggleLayout();
        });

        /** Sidebar **/
        function toggleSidebar() {
            if ($("#_w_layout").val() != 'boxed') return;
            $(".cmb2-id--w-sidebar-name").toggle(!$("#_w_sidebar_position1").is(":checked"));
            tabsChanged();
        }
        toggleSidebar();
        ...
        function toggleTitleBackground() {
            ...
            $(".cmb2-id--w-title-background-image, .cmb2-id--w-title-background-size, .cmb2-id--w-title-background-parallax").toggle($("#_w_title_background").val() == "image");
            ...
            $(".cmb2-id--w-title-overlay-color, .cmb2-id--w-title-overlay-opacity").toggle(($("#_w_title_background").val() == "image" || $("#_w_title_background").val() == "video"));
            tabsChanged();
        }
        ...
        function togglePostSidebarOptions() {
            $(".cmb2-id--w-sidebar-position, .cmb2-id--w-sidebar-name").toggle($("#_w_post_custom_sidebar").is(":checked"));
            tabsChanged();
        }
