    ...
    $.extend(wyde, {
        ...
        page: {
                ...
                setTimeout(function () {
                    $(".dropdown-nav .megamenu > ul").each(function () {
                        if ($(this).position().left > 0) {
                            $(this).css({ "left": -$(this).position().left, "width": $(".dropdown-nav").width() });
                        }
                    });
                }, 1000);
            ...
            initFullScreenNav: function () {
                ...
                var $scroller = $el.find(".full-nav-wrapper").css("max-height", $el.height() - $el.find(".social-icons").outerHeight(true)).wydeScroller({ scrollbar: false });
            ...
            return $(settings.element).each(function () {
                ...
                function loadResults(ajaxURL) {
                    ...
                    $.post(ajaxURL, data, function (response) {
                        ...
                        if (typeof self.updateLink == "function") self.updateLink($("li", $autocomplete.not("#product-list")));
