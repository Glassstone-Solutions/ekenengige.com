...
vc_map( array(
            'name' => __('Half Donut Chart', 'flora'),
            'description' => __('Animated half donut chart.', 'flora'),
            ...
            'params' => array(
                    ...
                    array(
                        ...
                        'admin_label' => true,
                        'value' => '',
                        'description' => __('Input chart value here. Choose range between 0 and 100.', 'flora')
                    ),
                    array(
                        'type' => 'dropdown',
                        'class' => '',
